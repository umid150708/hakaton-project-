/**
 * pricesFallback — curated wholesale market price dataset for Uzbekistan.
 *
 * Prices are in UZS, per the most common unit for each item.
 * Data curated: 2026-06-30. Sources: Chorsu, Ipodrom, O'zdon, regional markets.
 */
...
const DATA: FallbackPriceResult[] = [
...

  {
    ...
    count: 8, unit: '1 kg',
    source: 'curated', fetchedAt: FETCHED_AT,
    listings: [
